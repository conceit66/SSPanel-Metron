...
class AdminController extends UserController
{
    ...
    {
        $table_config['total_column'] = array(
            'id' => 'ID', 'user_id' => '用户ID',"user_name" => '用户名',
            'total' => '金额', 'status' => '状态',
    ...
    {
        $datatables = new Datatables(new DatatablesHelper());
        $datatables->query('Select log.id,log.userid as user_id,user.user_name,log.total,log.status,log.tradeno,log.datetime from paylist as log,user WHERE log.userid = user.id');
