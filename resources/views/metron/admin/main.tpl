        ...
        <div class="menu-content">
            ...
            <ul class="nav">
                <li>
                    ...
                    <a class="waves-attach" data-toggle="collapse" href="#ui_menu_document">文档</a>
                    <ul class="menu-collapse collapse in" id="ui_menu_document">
                        <li><a href="/admin/help/document"><i class="icon icon-lg">book</i>&nbsp;文档管理</a></li>
                        <li><a href="/admin/help/class"><i class="icon icon-lg">bookmark</i>&nbsp;分类管理</a></li>
                    </ul>
